"""Core functionality for DevPulse."""
...
def init(
    ...
    """Initialize DevPulse with configuration options.
    ...
    logger.info(f"DevPulse initialized with WebSocket URL: {websocket_url}")
...
def is_initialized() -> bool:
    """Check if DevPulse has been initialized.
